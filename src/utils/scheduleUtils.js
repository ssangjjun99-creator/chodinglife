...
export function makeDefaultSchedule() {
  ...
  return {
    0:[mk('기상','🌅','#5bc8f5',7,1),mk('학교','🏫','#7b9ef7',8,6),mk('영어학원','📖','#ffaa55',15,2),mk('피아노','🎹','#ff7eb3',17,1),mk('숙제','✏️','#ffe03a',18,1),mk('꿈나라','🌙','#7ab8e8',22,9)],
    1:[mk('기상','🌅','#5bc8f5',7,1),mk('학교','🏫','#7b9ef7',8,6),mk('수학학원','📚','#b07ef7',15,2),mk('수영','🏊','#00bcd4',17,1),mk('숙제','✏️','#ffe03a',18,1),mk('꿈나라','🌙','#7ab8e8',22,9)],
    2:[mk('기상','🌅','#5bc8f5',7,1),mk('학교','🏫','#7b9ef7',8,6),mk('영어학원','📖','#ffaa55',15,2),mk('숙제','✏️','#ffe03a',18,1),mk('꿈나라','🌙','#7ab8e8',22,9)],
    3:[mk('기상','🌅','#5bc8f5',7,1),mk('학교','🏫','#7b9ef7',8,6),mk('수학학원','📚','#b07ef7',15,2),mk('숙제','✏️','#ffe03a',18,1),mk('꿈나라','🌙','#7ab8e8',22,9)],
    4:[mk('기상','🌅','#5bc8f5',7,1),mk('학교','🏫','#7b9ef7',8,6),mk('자유시간','🎮','#f97fb8',15,2),mk('꿈나라','🌙','#7ab8e8',22,9)],
    5:[mk('기상','🌅','#5bc8f5',8,1),mk('피아노','🎹','#ff7eb3',10,1),mk('자유시간','🎮','#f97fb8',12,2),mk('스포츠','🏃','#22d3ee',14,2),mk('꿈나라','🌙','#7ab8e8',22,9)],
    6:[mk('기상','🌅','#5bc8f5',8,1),mk('독서','📕','#26d4b8',14,2),mk('자유시간','🎮','#f97fb8',16,2),mk('꿈나라','🌙','#7ab8e8',22,9)]
  };
}
...
export function checkHwWeekReset() {
  ...
  if(savedWeek !== thisMonday) {
    ...
    const photos = localStorage.getItem('chodinglife_hw_photos') || '{}';
    localStorage.setItem('chodinglife_hw_photos_last', photos);
    localStorage.setItem('chodinglife_hw_photos', '{}');
    localStorage.setItem('chodinglife_hw_week', thisMonday);
  }
}
